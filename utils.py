...
class Grid2Image(nn.Module):
    """
        ...
        source
        https://github.com/yangyangyang127/PointCLIP_V2/blob/main/zeroshot_cls/trainers/mv_utils_zs.py
    """
...
class Realistic_Projection:
    """For creating images from CLIDPoint based on the view information.
        source
        https://github.com/yangyangyang127/PointCLIP_V2/blob/main/zeroshot_cls/trainers/mv_utils_zs.py
    """
